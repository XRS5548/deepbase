      ...
      <section className="max-w-lg mx-auto px-6 pt-20 pb-24">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="text-center mb-10">
            ...
            <h1 className="font-heading text-4xl md:text-5xl text-hd-fg mb-4">Sign In</h1>
          ...
          >
            ...
            <p className="font-body text-sm text-center text-hd-fg/60">
              ...
              <Link href="/signup" className="text-hd-blue underline decoration-dashed underline-offset-4 hover:text-hd-accent">
                Sign up
              </Link>
            </p>
          </form>
